...
import in.co.bananowallet.bus.WalletClear;
import in.co.bananowallet.bus.WalletHistoryUpdate;
import in.co.bananowallet.bus.WalletPriceUpdate;
import in.co.bananowallet.bus.WalletSubscribeUpdate;
import in.co.bananowallet.network.model.response.AccountHistoryResponse;
import in.co.bananowallet.network.model.response.AccountHistoryResponseItem;
...
public class NanoWallet {
    ...
    public String getAccountBalanceNano() {
        return NumberUtil.getRawAsUsableString(accountBalance.toString())+" Bananos";
    }
