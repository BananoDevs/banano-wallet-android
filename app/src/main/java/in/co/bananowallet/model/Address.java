...
public class Address implements Serializable {
    ...
    public Spannable getColorizedShortSpannable() {
        ...
        // colorize the string
        s.setSpan(new ForegroundColorSpan(Color.parseColor("#36a936")), frontStartIndex, frontEndIndex, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    public boolean isValidAddress() {
        ...
        String chkvalue = getAddressWithoutPrefix();
        for (int i = 0; i < chkvalue.length() && isMatch; i++) {
            char letter = chkvalue.toLowerCase().charAt(i);
